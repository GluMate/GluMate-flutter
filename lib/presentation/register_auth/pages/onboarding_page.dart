...
class _OnBoardingPageState extends State<OnBoardingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    fit: BoxFit.contain,
    child: Text(
      AppLocalization.of(context).translate('On_boarding_title')!,
      ...
      textAlign: TextAlign.center,
                    ...
                    SizedBox(height: 1),
                      ...
                      child:   
                          ...
                          Text(AppLocalization.of(context).translate('On_boarding_desc')!
                      ,
                      style: GoogleFonts.roboto(fontSize: 16 , color: Color(0xFF8D8D8D)),
                      textAlign: TextAlign.center,
                    ),
                    ),
                    ...
                    child:  ElevatedButton(
                      ...
                      child: Padding(
                        ...
                        child:      Text(
                          AppLocalization.of(context).translate('Get_started')!
                      ,
              ...
              MaterialPageRoute(builder: (context) =>  const LoginPage()),
                          ...
                          AppLocalization.of(context).translate('already_memeber')!
                      ,
                         style: GoogleFonts.roboto(fontSize: 12 , color: Colors.blueAccent)))
    ...
    Navigator.push(
              ...
              MaterialPageRoute(builder: (context) =>  roleWidget()),
                      ...
                      child: Padding(
                        padding: EdgeInsets.all(10),
                        child: Text(
                          AppLocalization.of(context).translate('sign_up_with_email')!
                      ,
                          style: GoogleFonts.roboto(fontSize: 20 , color: Colors.white),
                        ),
                      ),
