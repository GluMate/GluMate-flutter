...
abstract class GlucRepository {
  ...
  Future<Either<Failure,List<GlucEntity>>> fetchRecords({required String token,required String id , required int limit});  
  Future<Either<Failure,List<RecordEntity>>> fetchRecordsByTime({required String token,required DateTime start,required DateTime end , String? gran});  
}