...
class UserRepositoryImpl implements UserRepository {
  ...
  UserRepositoryImpl({required this.networkInfo , required this.userRemoteDataSource , required this.localDataSource});
  @override
...
// login method returns either failure or connected user from nodeJs server after firebase auth
@override
